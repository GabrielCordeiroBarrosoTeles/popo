	...
	<nav class="z-depth-4">
        <div class="nav-wrapper indigo">
            ...
            <ul id="nav-mobile" class="hide-on-med-and-down left">
                ...
                <li class="kk"><a href="pesquisar.php">Pesquisar Data OS</a></li>
                <li class="kk"><a href="pesquisar_placa.php">Pesquisar Placa</a></li>
                <li class="kk"><a href="pesquisar_cpf.php">PesquisarCpf</a></li>
                <li class="kk"><a href="pesquisar_mecanico.php">Pesquisar Meânico</a></li>
